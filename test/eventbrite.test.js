...
describe('eventbrite', function(){
    it('should be scrumfest-sendai if ordernumber is $ordernumber_for_test', function(){
        const conference_name = "scrumfest-sendai";
        const eventbrite_order_id = "7307425449";
